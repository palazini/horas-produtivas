...
import { generateResultsExcel } from '../utils/excelExport'
...
export function ResultsPage() {
    ...
    function handleExportExcel() {
        if (!effectiveRefDate) return
        generateResultsExcel(
            grouped as any,
            effectiveRefDate,
            viewType,
            dailyTrack // New Data Source
        )
    }
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start justify-between gap-4 flex-wrap">
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button onClick={handleExportExcel} disabled={busy} className="btn" style={{ background: '#107c41', color: 'white', border: 'none' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
